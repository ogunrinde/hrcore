                  ...
                  <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                      ...
                      <div class="x_content">
                        ...
                        <?php } ?>
                        <form action = "admin_login_user.php" method="POST" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                          ...
                          <div class="col-md-12 col-sm-6 col-xs-12 col-md-offset-3">
                            <p>Don't have an account? <a class="btn btn-primary" href="admin_register">Admin Register</a></p>
                          </div>
                        </form>
                      </div>
                    </div>
